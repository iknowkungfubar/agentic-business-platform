...
class TestModelSelector:
    ...
    def test_simple_qa_routes_to_t1(self, selector):
        ...
        intent = IntentResult(
            intent_type="question_answering", confidence=0.8, reason="test"
        )
    ...
    def test_summarization_routes_to_t1(self, selector):
        ...
        intent = IntentResult(
            intent_type="summarization", confidence=0.8, reason="test"
        )
    ...
    def test_data_extraction_routes_to_t2(self, selector):
        ...
        intent = IntentResult(
            intent_type="data_extraction", confidence=0.8, reason="test"
        )
    ...
    def test_code_generation_routes_to_t3(self, selector):
        ...
        intent = IntentResult(
            intent_type="code_generation", confidence=0.8, reason="test"
        )
    ...
    def test_complexity_keywords_upgrade_tier(self, selector):
        ...
        route = selector.select(
            intent,
            "What is the optimal distributed architecture for concurrent processing?",
        )
    ...
    def test_route_result_has_reason(self, selector):
        ...
        intent = IntentResult(
            intent_type="code_generation", confidence=0.9, reason="test"
        )
